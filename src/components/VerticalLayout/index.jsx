  ...
  toggleMenuCallback = () => {
    if (this.props.leftSideBarType === "default") {
      if(!this.state.isMobile) {
        this.props.changeSidebarType("icon", this.state.isMobile);
      }
      else this.props.changeSidebarType("condensed", this.state.isMobile);
    ...
    else if (this.props.leftSideBarType === "icon") {
      this.props.changeSidebarType("default", this.state.isMobile);
